<header class="hidden lg:grid grid-rows-1 grid-cols-6 z-10 pr-5 w-full pl-64 fixed h-24 bg-gray-50 xl:pr-0">
    ...
    <div class="flex items-center justify-end pr-5 col-span-1">
        <a class="text-l font-medium tracking-wide">{{-- Auth::user()->pegawai->namapegawai --}} John Doe</a>
    </div>
</header>
